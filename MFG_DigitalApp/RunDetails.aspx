                    ...
                    <section class="content">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                ...
                                <asp:Label runat="server" ID="lblshiftnew" Text=""></asp:Label></li>
                            <li class="breadcrumb-item">
                        ...
                        <div class="box box-default" style="margin-top: 7px;">
                                ...
                                <div class="row">
                                    <div class="col-md-12 table-responsive">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Action">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:LinkButton Text="Restart" runat="server" CommandArgument='<%#Eval("PONumber") %>' ID="lnkRestartPO" OnClick="lnkRestartPO_Click" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        ...
                                        <asp:GridView runat="server" ID="GrdCompleted" AutoGenerateColumns="false" EmptyDataText="No Records Found!!"
                                            ...
                                            OnPageIndexChanging="GrdCompleted_PageIndexChanging" OnRowDataBound="GrdCompleted_RowDataBound">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Action">
                                                    <ItemTemplate>
                                                        <asp:LinkButton Text="Restart" runat="server" CommandArgument='<%#Eval("PONumber") %>' ID="lnkRestartPOCompleted" OnClick="lnkRestartPOCompleted_Click" Visible='<%#Convert.ToBoolean(Eval("AutoStopProduction"))==true?true:false %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                            <PagerStyle CssClass="GridPager" />
                                            ...
                                            <div style="width: 100%;">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 col-sm-4 col-xs-4">
                                                        <div class="form-group has-feedback">
                                                            <label>EDP</label>
                                                            <%--<asp:DropDownList ID="drpEDP" runat="server" CssClass="form-control select2" OnSelectedIndexChanged="drpEDP_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>--%>
                                                            
                                                            <asp:TextBox ID="txtEDP" runat="server" CssClass="form-control" OnTextChanged="txtEDP_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                            <%--<asp:AutoCompleteExtender ID="TextBox1_AutoCompleteExtender" runat="server" DelimiterCharacters="" Enabled="true" ServiceMethod="GetOperatorByEDP" MinimumPrefixLength="1" EnableCaching="true" TargetControlID="txtEDP">
                                                            </asp:AutoCompleteExtender>--%>
                                                            <%--<asp:DropDownList ID="drpOperator" runat="server" CssClass="form-control select2-dropdown--below">
                                                            </asp:DropDownList>--%>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 col-sm-4 col-xs-4">
                                                        <div class="form-group has-feedback">
                                                            <label>Name</label>
                                                            <asp:DropDownList ID="drpOperator" runat="server" CssClass="form-control select2" OnSelectedIndexChanged="drpOperator_SelectedIndexChanged" AutoPostBack="true">
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="modal-body table-responsive" style="height: 200px; overflow-y: scroll;">
                                                            <div style="width: 100%;">
                                                                <asp:GridView runat="server" ID="GrdOperators" AutoGenerateColumns="false" EmptyDataText="No Records Found!!"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundField DataField="EDP" HeaderText="EDP" />
                            ...
                            <!-- ModalPopupExtender for restart po-->
                            <asp:Button ID="btnPopupRestartPO" runat="server" Style="display: none" />
                            <asp:ModalPopupExtender ID="MPRestartPO" runat="server" TargetControlID="btnPopupRestartPO"
                                PopupControlID="myModalAlertRestartPO" CancelControlID="btnOkRestartPo" BackgroundCssClass="modalBackground">
                            </asp:ModalPopupExtender>
                            <div id="myModalAlertRestartPO">
                                <div class="modal-dialog" style="width: auto;">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4>
                                                <label>Restart Process Order</label></h4>
                                            <asp:Label runat="server" ID="lblReStartMessage" ForeColor="Red" Font-Bold="true"></asp:Label>
                                        ...
                                        <div class="modal-body">
                                            <div style="width: 100%;">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 col-sm-4 col-xs-4">
                                                        <div class="form-group has-feedback">
                                                            <asp:TextBox ID="txtRestartDate" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                                                            <%--<asp:CalendarExtender ID="CalendarExtender1" runat="server" Format="yyyy-MM-dd" Enabled="True"
                                                                TargetControlID="txtRestartDate">
                                                            </asp:CalendarExtender>--%>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 col-sm-4 col-xs-4">
                                                        <div class="form-group has-feedback">
                                                            <asp:DropDownList ID="ddlRestartTime" runat="server" CssClass="form-control select2">
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-8 col-sm-8 col-xs-8">
                                                        <label>Enter additional cases that need to be produced : </label>
                                                    </div>
                                                    <div class="col-md-4 col-sm-4 col-xs-4">
                                                        <div class="form-group has-feedback">
                                                            <asp:TextBox ID="txtPOQuantity" runat="server" placeholder="Cases" CssClass="form-control"></asp:TextBox>
                                                            <asp:RequiredFieldValidator ID="rfvqty" ControlToValidate="txtPOQuantity" runat="server" ErrorMessage="Please enter quantity" ValidationGroup="validate" InitialValue="0"></asp:RequiredFieldValidator>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal-footer">
                                            <asp:Button runat="server" ID="btnRestart" CssClass="btn btn-primary" Text="Restart PO" OnClick="btnRestart_Click" ValidationGroup="validate" />
                                            <asp:Button runat="server" ID="btnOkRestartPo" CssClass="btn btn-default" Text="Close" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="modal-body">
                                            <div style="width: 100%;">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 col-sm-8 col-xs-8">
                                                        <div class="form-group has-feedback">
                                                            <asp:DropDownList ID="drpBatch" runat="server" CssClass="form-control select2"
                                                                OnSelectedIndexChanged="drpBatch_SelectedIndexChanged" AutoPostBack="true">
                                                            </asp:DropDownList>
                                                    ...
                                                    <div class="col-md-4 col-sm-4 col-xs-4">
                                                        <div class="form-group has-feedback">
                                                            ...
                                                            <asp:CalendarExtender ID="calScheduleStart" runat="server" Format="yyyy-MM-dd" Enabled="True"
                                                                TargetControlID="txtScheduleStart"></asp:CalendarExtender>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 col-sm-4 col-xs-4">
                                                        <div class="form-group has-feedback">
                                                    ...
                                                    <div class="col-md-4 col-sm-4 col-xs-4">
                                                        <div class="form-group has-feedback">
                                                            ...
                                                            <asp:CalendarExtender ID="CaltxtStopDate" runat="server" Format="yyyy-MM-dd" Enabled="True"
                                                                TargetControlID="txtStopDate"></asp:CalendarExtender>
