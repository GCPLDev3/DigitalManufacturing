<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.Master" CodeBehind="In_Process.aspx.cs"  enableEventValidation ="false" Inherits="MFG_DigitalApp.In_Process" %>
                ...
                <div class="container">
                    <section class="content">
                        ...
                        <div class="row" runat="server" id="HeaderButtons">
                             <div class="col-md-3">
                                 <a class="level static" href="In_Process.aspx" tabindex="-1">In-Process</a>
                            ...
                            <div class="box-body">
                                ...
                                <div class="row" style="margin-top: 10px;">
                                    <div class="col-md-12 table-responsive">
                                        <asp:GridView runat="server" ID="GrdInProcessScheduleStatus" RowStyle-HorizontalAlign="Center" DataKeyNames="Id,ScheduleId" AutoGenerateColumns="false" EmptyDataText="No Records Found!!"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText ="Result">
                                                         <ItemTemplate>
                                                            <asp:TextBox ID="Result" Text='<%#Eval("Result")%>' runat="server"  onkeypress="return isNumeric(event,this)"   CssClass="form-control"  />
                                         ...
                                         <asp:GridView runat="server" ID="GrdInProcessCompletedScheduleStatus" RowStyle-HorizontalAlign="Center" DataKeyNames="Id,ScheduleId"  AutoGenerateColumns="false" EmptyDataText="No Records Found!!"
...
<%--                                                            <asp:CustomValidator ID="cfvExpectedResult" runat="server" ErrorMessage="Required" ForeColor="Red" ValidationGroup="G1" ControlToValidate="Result" ClientValidationFunction="checkValuesInRow" ValidateEmptyText="true"></asp:CustomValidator>--%>
                             ...
                             <div class="row" runat="server" id="SubmitButton">
                                    <div class="col-md-12" align="Right">
                                        <asp:Button runat="server" ID="btnSaveResult1" CssClass="btn btn-primary" Text="Save" OnClick="btnSaveResult_Click" />
<%--                                        <asp:Button runat="server" ID="btnPreviousResult" CssClass="btn btn-primary" Text="Previous Result" OnClick="btnPreviousResult_Click" />--%>
                                 ...
                                 <div class="row" runat="server" id="ResumbitButton">
                                    <div class="col-md-12" align="Right">
                                        <asp:Button runat="server" ID="btnEdit" CssClass="btn btn-primary" Text="Save" OnClick="btnEdit_Click" />
<%--                                        <asp:Button runat="server" ID="btnPreviousResult" CssClass="btn btn-primary" Text="Previous Result" OnClick="btnPreviousResult_Click" />--%>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div style="width: 100%;">
                                                ...
                                                <div class="row">
												 ...
												 <div class="row" Id="QuantitativeGroup" runat="server">
                                                   ...
                                                   <div class="col-md-4 col-sm-4 col-xs-4">
                                                        <div class="form-group has-feedback">
															<asp:TextBox ID="txtLCL" runat="server" AutoPostBack="True" CssClass="form-control" MaxLength="7" onkeypress="return isNumberKey(event)" OnTextChanged="OnFieldChange"></asp:TextBox>
														</div>
                                                    </div>
													<div class="col-md-2 col-sm-2 col-xs-2">
                                                        <label>Tol.UCL</label>
                                                    ...
                                                    <div class="col-md-4 col-sm-4 col-xs-5">
                                                        <div class="form-group has-feedback">
															 <asp:TextBox ID="txtUCL" runat="server" AutoPostBack="True" CssClass="form-control" MaxLength="7" onkeypress="return isNumberKey(event)" OnTextChanged="OnFieldChange"></asp:TextBox>
