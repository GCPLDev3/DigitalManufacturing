                                ...
                                <div class="row">
                                    <div class="col-md-1 col-sm-1 col-xs-1">
                                        <div class="form-group has-feedback">
                                            <label>Date</label>
                                            <asp:TextBox ID="txtDate" runat="server" CssClass="form-control" Width="85px"></asp:TextBox>
                                    ...
                                    <%--<div class="col-md-1 col-sm-1 col-xs-1" style="width: 10px;">
                                    </div>--%>
                                    <div class="col-md-1 col-sm-1 col-xs-1">
                                        <div class="form-group has-feedback">
                                            <label>Shift</label>
                                            <asp:DropDownList ID="drpShift" runat="server" CssClass="form-control select2" Width="100px">
                                            </asp:DropDownList>
                                    ...
                                    <div class="col-md-1 col-sm-1 col-xs-1">
                                        <div class="form-group has-feedback">
                                            <label>P.Time</label>
                                            <asp:DropDownList ID="ddlHour" runat="server" CssClass="form-control select2" Width="75px">
                                            </asp:DropDownList>
                                    ...
                                    <div class="col-md-1 col-sm-1 col-xs-1">
                                        <div class="form-group has-feedback topmarg">
                                            <asp:DropDownList ID="ddlMinute" runat="server" CssClass="form-control select2" Width="75px">
                                            </asp:DropDownList>
                                      ...
                                      <div class="col-md-2 col-sm-2 col-xs-2">
                                        <div class="form-group has-feedback">
                                            <label>Station</label>
                                            <asp:DropDownList ID="ddlStation" runat="server" CssClass="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="ddlStation_SelectedIndexChanged">
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator InitialValue="0" ID="ReqStation" Display="Dynamic" ValidationGroup="g1" runat="server" ControlToValidate="ddlStation" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-1 col-sm-1 col-xs-1">
                                        <div class="form-group has-feedback">
                                            <label>Act.Value</label>
                                            <asp:TextBox ID="txtValue" runat="server" Width="70px" CssClass="form-control" MaxLength="8" onkeypress="return validateFloatKeyPress(this,event);"></asp:TextBox>
                                    ...
                                    <div class="col-md-1 col-sm-1 col-xs-1">
                                           <label>Targ.Value</label>
                                            <asp:TextBox ID="txtTargValue" runat="server" Width="70px" CssClass="form-control" MaxLength="8" onkeypress="return validateFloatKeyPress(this,event);"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" Display="Dynamic" ValidationGroup="g1" runat="server" ControlToValidate="txtTargValue" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="col-md-1 col-sm-1 col-xs-1">
                                        <div class="form-group has-feedback">
                                            <label>UOM</label>
                                            <asp:TextBox ID="txtUOM" runat="server" Width="60px" CssClass="form-control" MaxLength="10"></asp:TextBox>
                                        ...
                                        <asp:GridView runat="server" ID="GrdProduction" AutoGenerateColumns="false" EmptyDataText="No Records Found!!" DataKeyNames="AutoId"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Value" HeaderText="Actual Value" />
                                                  <asp:BoundField DataField="Targ" HeaderText="Target Value" />
